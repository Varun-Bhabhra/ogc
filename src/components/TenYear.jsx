...
const TenYear = () => {
  return (
    <div className="relative bgwhite py-6 sm:py-8 lg:py-12">
      <video
        autoPlay
        muted
        loop
      ...
      <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
        <div className="relative flex flex-wrap rounded-lg px-4 py-3 justify-center sm:flex-nowrap sm:items-center sm:justify-center sm:gap-3 sm:pr-8 md:px-8">
          <div className="order-1 mb-2 inline-block w-11/12 max-w-screen-sm text-lg md:text-xl text-white font-bold sm:order-none sm:mb-0 sm:w-auto lg:text-3xl text-center">
